...
<head>
    ...
    <style>
        ...
        .card-header {
            ...
            text-align: center;
            padding: 1.5rem 0; /* Tambahkan padding agar tidak kosong */
        }
        .card-body {
            padding: 2rem;
        }
        ...
        /* Style untuk pesan error validasi agar terlihat lebih rapi di dalam body */
        .alert-validation {
            font-size: 0.875rem;
            margin-bottom: 1rem;
        }
        ...
        <div class="col-md-5">
            <div class="card login-card">
                ...
                <div class="card-body">
                    ...
                    @if (session('status'))
                        <div class="alert {{ session('status') == 'success' ? 'alert-success' : 'alert-danger' }} alert-validation" role="alert">
                    ...
                    @if ($errors->any())
                        <div class="alert alert-warning alert-validation">
                            <ul>
